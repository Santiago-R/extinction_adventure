...
dino_info = [
    ...
    {'name': 'Diplodocus verde', 'incubation': 5, 'ecosystem': ['jungla'], 'description': 'En caso de incendio, protege hasta tres dinosarios distintos al diplodocus verde.'},
    {'name': 'Diplodocus rocoso', 'incubation': 4, 'ecosystem': ['volcán'], 'description': 'En caso de erupción volcánica, protege hasta dos dinosarios distintos al diplodocus rocoso.'},
    ...
    {'name': 'Espinosaurio', 'incubation': 2, 'ecosystem': ['jungla'], 'description': 'Puede devorar instantáneamente a un dinosaurio cada turno. El jugador que jugó el dinosaurio devorado roba una carta.'},
